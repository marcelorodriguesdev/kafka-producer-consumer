...
import br.com.kafka.ecommerce.ConsumerFunction;
import br.com.kafka.ecommerce.configuration.GsonDeserializer;
...
public class KafkaService<T> implements Closeable {
    ...
    public KafkaService(String groupId, String topic, ConsumerFunction parse, Class<T> clazz, Map<String, String> properties) {
        this(parse, groupId, clazz, properties);
    ...
    private KafkaService(ConsumerFunction parse, String groupId, Class<T> clazz, Map<String, String> properties) {
        this.parse = parse;
